...
public class DemoStep extends BaseStep implements StepInterface {
  ...
  public static final RowMetaAndData buildRow(DemoStepMeta meta, List<Field> fields, List<CheckResultInterface> remarks,
  ...
  public static int getValType(String fieldTypeName) {
    // data.fields.get(i).getType().toString()
    ...
    System.out.println("GUGUGAGA: " + valtype);
    return valtype;
  }
